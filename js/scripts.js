jQuery.noConflict()(function ($) {
  ...
  let heightHeader = $("header").height() + 60;
  // fixed_offset = $('.main-bar').height() + 10;
  function scrollBlock() {
    $("html, body").animate(
      { scrollTop: $(".form-orders-section").offset().top - heightHeader },
      1000
    );
  }
  ...
  $('input[name="auto"]').on("click", function () {
    ...
    $("#form-order .tab-item.select").removeClass("select");
    $('#form-order .tab-item[data-tab="2"]').addClass("select");

    $(".tabs li.active").removeClass("active");
    $(".tabs li:nth-of-type(2)").addClass("active");
    var activeWidth = $($(".tabs li:nth-of-type(2)")).innerWidth();
    var activeHeight = $($(".tabs li:nth-of-type(2)")).innerHeight();
    var itemPos = $($(".tabs li:nth-of-type(2)")).position();
    $(".selector").css({
      top: itemPos.top + "px",
      width: activeWidth + "px",
      height: activeHeight + "px",
  ...
  $(".next, .skip").click(() => {
    $("#form-order .tab-item.select").removeClass("select");
    $('#form-order .tab-item[data-tab="3"]').addClass("select");

    $(".tabs li.active").removeClass("active");
    $(".tabs li:nth-of-type(3)").addClass("active");
    var activeWidth = $($(".tabs li:nth-of-type(3)")).innerWidth();
    var activeHeight = $($(".tabs li:nth-of-type(3)")).innerHeight();
    var itemPos = $($(".tabs li:nth-of-type(3)")).position();
    $(".selector").css({
      top: itemPos.top + "px",
      width: activeWidth + "px",
      height: activeHeight + "px",
  ...
  $(".done-order").click(() => {
    ...
    $("#form-order .tab-item.select").removeClass("select");
    $('#form-order .tab-item[data-tab="4"]').addClass("select");

    $(".tabs li.active").removeClass("active");
    $(".tabs li:nth-of-type(4)").addClass("active");
    var activeWidth = $($(".tabs li:nth-of-type(4)")).innerWidth();
    var activeHeight = $($(".tabs li:nth-of-type(4)")).innerHeight();
    var itemPos = $($(".tabs li:nth-of-type(4)")).position();
    $(".selector").css({
      top: itemPos.top + "px",
      width: activeWidth + "px",
      height: activeHeight + "px",
  ...
  function fl_comment_insert() {
    $(".comment-field-wrapper").each(function () {
      $(".fl-comment-form")
        .find(".author-comment")
        .insertBefore(".comment-field-wrapper");
    });
  }
          ...
          $this.find(".fl-progress-wrapper").animate(
            { text: $this.attr("data-progress-width") },
            {
              ...
              step: function (now) {
                ...
                $this
                  .find(".fl-progress-bar__number .fl-animated-number")
                  .html(data + "%");
              },
            }
          );
  ...
  $window.initAccordionFunction = function () {
    ...
    fl_accordion.each(function () {
      ...
      $this
        ...
        .append(
          "<span class='fl-counter-animated-icon'><i class='fa fa-angle-right'></i></span>"
        );
    });
  };
  // AnimatedTyping
  ...
  $window.initHotspot = function () {
    ...
    $(".fl-hotspot-shortcode").each(function () {
      let $self = $(this),
        hotspotContent = $self.data("hotspot-content")
          ? $self.data("hotspot-content")
          : "";

      if (
        hotspotContent != "" &&
        !$self.find(".fl-hotspot-image-cover").hasClass("fl-htospot-inited")
      ) {
        $self
          .find(".fl-hotspot-image-cover")
          .addClass("fl-htospot-inited")
          .hotspot({
  ...
  $window.initCustomWidgetRange = function () {
    if ($("#slider-price").length > 0) {
      ...
      var max_slider_price = document.getElementById(
        "pix-max-slider-price"
      ).value;

      var pix_thousand = document.getElementById("pix-thousand").value;
      var pix_decimal = document.getElementById("pix-decimal").value;
      var pix_decimal_number =
        document.getElementById("pix-decimal_number").value;
    ...
    if ($("#slider-year").length > 0) {
      ...
      var max_slider_year = document.getElementById(
        "pix-max-slider-year"
      ).value;
    ...
    if ($("#slider-mileage").length > 0) {
      ...
      var max_slider_mileage = document.getElementById(
        "pix-max-slider-mileage"
      ).value;
    ...
    if ($("#slider-engine").length > 0) {
      ...
      var max_slider_engine = document.getElementById(
        "pix-max-slider-engine"
      ).value;
  ...
  $window.initMobileNavigationOpenClose = function () {
    ...
    self.openFullscreenNavbar = function () {
      ...
      let $navbarMenuItems = $navbar_wrapper.find(
    ...
    $doc.on(
      "click",
      ".fl--hamburger-menu-wrapper,.fl--mobile-menu-icon,.fl--hamburger-menu",
      function (e) {
...
-------------------------------------------------------------------*/
  ...
  $(document).ready(function () {
    ...
    if (
      $window &&
      typeof parent.vc != "undefined" &&
      typeof parent.vc.events != "undefined"
    ) {
